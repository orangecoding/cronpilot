...
export function Header({ onNew }) {
  return (
    <header className="sticky top-0 z-20 flex items-center justify-between px-5 sm:px-8 py-3 bg-[#080b14]/95 backdrop-blur-md border-b border-[#1a2540]">
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col gap-0.5 leading-none">
          ...
          <span className="text-[9px] font-semibold text-[#3d5070] uppercase tracking-[0.18em]">job scheduler</span>
        </div>
      </div>
